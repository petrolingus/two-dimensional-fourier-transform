...
public class Interpolation {
     ...
     */
    public static double bilinearInterpolate(double _00, double _10, double _01, double _11, double t, double u) {
        return interpolate(interpolate(_00, _10, t), interpolate(_01, _11, t), u);
    }
     ...
     */
    public static double bilinearInterpolate(double xs[], double ys[], Matrix z, double x, double y) {
     ...
     */
    public static double bilinearInterpolate(double xs[], double ys[], Matrix z, double x, double y, boolean wrapX, boolean wrapY) {
        return bilinearInterpolate(
                Matrix.rowMajor(1, xs.length, xs).elementsByRow(),
                Matrix.rowMajor(1, ys.length, ys).elementsByRow(), z, x, y, wrapX, wrapY);
    }
     ...
     */
    public static double bilinearInterpolate(List<Double> xs, List<Double> ys, Matrix z, double x, double y) {
        return bilinearInterpolate(xs, ys, z, x, y, false, false);
    }
     ...
     *                                  the correct dimensions.
     */
    public static double bilinearInterpolate(List<Double> xs, List<Double> ys, Matrix z, double x, double y, boolean wrapX, boolean wrapY) {
     ...
     */
    public static double bilinearInterpolate(double x0, double x1, double y0, double y1, Matrix z, double x, double y) {
